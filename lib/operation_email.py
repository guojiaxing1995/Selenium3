...
class OperationEmail():
    ...
    #使用第三方SMTP服务
    def SMTP_QQ_send_email(self,receivers,subject,content,format='plain',attachment_path=None,attachment_name=None):
...
if __name__=='__main__':
    ...
    subject = '测试邮件标题'
    content = '测试报告邮件内容正文'
    opreaemail = OperationEmail()
    opreaemail.SMTP_QQ_send_email(receivers,subject,content,'plain','../case_excel/case.xls','测试报告.xls')